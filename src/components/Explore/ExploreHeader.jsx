...
const ExploreHeader = ({search, setSearch, onSearch}) => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex gap-5">
        ...
        <div className="flex items-center flex-1 h-24 p-5 bg-white border border-gray-200 rounded-xl shadow-sm">
          ...
          <button onClick={onSearch} className="flex items-center justify-center h-12 gap-2 px-7 font-medium text-white bg-indigo-600 rounded-r-xl hover:bg-indigo-700 active:bg-indigo-800 transition">
